...
class MIDITrack:
    ...
    class note(GenericEvent):
        '''A class that encapsulates a class_note
        '''
    ...
    def addNoteByNumber(self,channel, pitch,time,duration,volume):
        '''Add a class_note by chromatic MIDI number
        '''
    ...
    def writeMIDIStream(self):
        '''
        Write the meta data and class_note data to the packed MIDI stream.
        '''
...
class MIDIFile:
    ...
    def addNote(self,track, channel, pitch,time,duration,volume):
        ...
        Arguments:
            track: The track to which the class_note is added.
            channel: the MIDI channel to assign to the class_note. [Integer, 0-15]
            pitch: the MIDI pitch number [Integer, 0-127].
            time: the time (in beats) at which the class_note sounds [Float].
            duration: the duration of the class_note (in beats) [Float].
            volume: the volume (velocity) of the class_note. [Integer, 0-127].
        """
    ...
    def changeNoteTuning(self,  track,  tunings,   sysExChannel=0x7F,  \
        ...
        """
        Change a class_note's tuning using SysEx change tuning program.
        ...
        Arguments:
            ...
            sysExChannel: do class_note use (see below).
        ...
        Also class_note that many software packages and hardware packages do not implement
        this standard!
        """
